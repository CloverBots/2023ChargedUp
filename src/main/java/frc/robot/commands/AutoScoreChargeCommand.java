...
public class AutoScoreChargeCommand extends SequentialCommandGroupExtended {
  private final static double DRIVE_SPEED = .4; // .5, need to tune at competition
  private final static double DISTANCE = -2.3; // -2.73
  private final static double BALANCE_DISTANCE = -0.9;
  private final static double BALANCE_SPEED = -.2; //must be negative to backwards
  private final static double BACKUP_DISTANCE = .1;
  private final static double BACKUP_SPEED = .15;
